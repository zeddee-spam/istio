    ...
    return [
        {
            ...
            'descriptionHtml': '<a href="https://en.wikipedia.org/wiki/The_Comedy_of_Errorz">Wikipedia Summary</a>: The Comedy of Errorz is one of <b>William Shakespeare\'s</b> early plays. It is his shortest and one of his most farcical comedies, with a major part of the humour coming from slapstick and mistaken identity, in addition to puns and word play.'
        }
    ]
